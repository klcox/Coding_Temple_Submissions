...
class DataPipeline:
    ...
    def __init__(self, filepath):
        ...
        Converts the CSV data into a DataFrame to be used with pandas. 
        The DataFrame remains empty if the filepath cannot be found so as to prevent later errors.
        """
    ...
    def clean(self):
        ...
        # Remove rows with duplicated Employee IDs
    ...
    def analyze(self):
        """
        Computes summary statistics from the cleaned self.df.
        ...
        corr_data = self.df[["years_experience", "salary"]].dropna()
    ...
    def visualize(self, output_path="output/charts.png"):
        ...
        If the DataFrame is empty, the method does not attempt to produce charts; it prints a message and exits the method.
        """
        ...
        plt.savefig(output_path, dpi=120, bbox_inches="tight")  # Save charts as image file, resolution        
        plt.close()
